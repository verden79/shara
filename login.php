	...
	<div class="headerInner">
		...
		<div id="login">
			<div id="regform">
				<div id="dvform">
					<h2>Вход</h2>
					<form method="POST" action = "main/verify.php">
						<input class="tbin" type="text" name= "flogin"></input>
						<input class="tbin" type="password" placeholder="Пароль" name= "fpassword"></input>
						<input id="btsub" type="submit" value="ВОЙТИ"></input>
						<h3><a  href="#"> ЗАБЫЛИ ПАРОЛЬ?</a></h3>
						<h5><a  href="./register.php"> зарегистрироваться</a></h5>
					</form>
				</div>
			</div>
